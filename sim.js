	...
	107: function(t, a, r) {
		...
		var n = function() {
				var t = this,
					...
					r = t._self._c || a;
				return r("div", {
					staticClass: "ui two column stackable grid", //if stackable class removed it is visble in<768px also 
					attrs: {
						id: "app"
					}
				...
				t._v(" "),r("div", {
					staticClass: "middle aligned center aligned column"
				}, [r("h2", {
			...
			e = [function() {
				...
				return r("div", {
					...
					staticClass: "ui header"
				}, [t._v("Editor")]), t._v(" "), r("div", {
					staticClass: "ui stackable labels"
				}, [r("span", {
	...
	84: function(t, a, r) {
		...
		var n = function() {
				...
				return r("div", {
					...
					staticClass: "header"
				}, [t._v("Important Note")]), t._v(" "), t._m(0), t._v(" "), r("div", {
					staticClass: "actions"
				}, [r("div", {
	...
	92: function(t, a, r) {
		...
		var n = function() {
				...
				return r("div", {
					...
					staticClass: "ui small very basic very compact center aligned table"
